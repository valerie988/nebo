...
// Read the API URL dynamically from your app.config.js / app.json extra properties
    ...
    <View className="flex-1 bg-[#F8FDF9]">
      <SafeAreaView className="flex-1">
        <ScrollView
          ...
          refreshControl={
            <RefreshControl refreshing={refreshing} onRefresh={fetchInsights} />
          }
        >
          {/* Header */}
          <View className="mb-8">
            ...
            <Text className="text-[#52B788] text-xs font-bold">
              See what is moving in the market
            </Text>
          </View>

          {/* Performance Chart Placeholder */}
          <View className="bg-white p-6 rounded-[40px] border border-[#D8F3DC] mb-8 shadow-sm">
            <Text className="text-[#1B4332] font-black text-lg mb-4">
              Views Overview
            </Text>
          ...
          <View className="flex-row justify-between mb-6">
            <View className="bg-[#E9F7EF] p-5 rounded-[32px] w-[48%]">
              ...
              <Text className="text-[#52B788] text-[10px] font-bold uppercase">
                Trending Now
              </Text>
            </View>
            ...
            <View className="bg-white p-5 rounded-[32px] w-[48%] border border-[#D8F3DC]">
              ...
              <Text className="text-[#1B4332] font-black text-xl mt-2">
                1,240
              </Text>
              <Text className="text-[#95D5B2] text-[10px] font-bold uppercase">
                Profile Visits
              </Text>
            </View>
          </View>
          ...
          <Text className="text-[#1B4332] text-xl font-black mb-4">
            Inventory Health
          </Text>
          ...
          <View className="bg-white rounded-[32px] p-6 border border-[#D8F3DC] mb-6">
            <View className="flex-row justify-between items-center mb-6">
              <View>
                ...
                <Text className="text-[#95D5B2] text-xs">
                  {stockLevel} units currently listed
                </Text>
              </View>
            ...
            <Text className="text-[#52B788] text-[10px] font-bold mt-2">
              65% of your capacity utilized
            </Text>
          </View>
          ...
          {["Vegetables", "Tubers", "Poultry"].map((cat, index) => (
            <View
              key={cat}
              className="flex-row items-center bg-white p-4 rounded-3xl border border-[#D8F3DC] mb-3"
            >
              ...
              <View className="bg-[#E9F7EF] px-3 py-1 rounded-full">
                <Text className="text-[#1B4332] text-[10px] font-black">
                  High Demand
                </Text>
              </View>
            </View>
