        ...
        <KeyboardAvoidingView className="flex-1" behavior={Platform.OS === "ios" ? "padding" : "height"}>
          <ScrollView contentContainerStyle={{ flexGrow: 1 }} keyboardShouldPersistTaps="handled">
            ...
            <View className="flex-1 bg-white rounded-t-[60px] px-8 pt-11 pb-10">
              <Text className="text-primary text-[34px] font-[800] mb-8">Login</Text>
              ...
              <TouchableOpacity onPress={handleLogin} disabled={loading} className="bg-primary rounded-full py-[18px] items-center">
                {loading ? <ActivityIndicator color="white" /> : <Text className="text-white text-xl font-[800]">Login</Text>}
              </TouchableOpacity>

              <View className="flex-row justify-center mt-9 mb-2">
                <Text className="text-primary font-medium text-sm">Don't have an account? </Text>
